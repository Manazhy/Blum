...
{magenta}| __  |  |  |  |  |     | {green}Author : {white} 𝐂𝐑𝐈𝐌𝐈𝐍𝐀𝐋
{magenta}| __ -|  |__|  |  | | | | {white}𝗕𝗨𝗚 𝗙𝗜𝗫𝗘𝗗 𝗕𝗬  : {green}  𝗔𝗣𝗞 𝗦𝗛𝗔𝗗𝗢𝗪
{magenta}|_____|_____|_____|_|_|_| {green}Note : {white} ENJOY AND GIVE FEEDBACK 
        """
